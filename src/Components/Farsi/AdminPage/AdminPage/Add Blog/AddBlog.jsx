...
// Functions
import { AddBlogVal } from "../../../../../Functions/AddBlogVal";
            ...
            axios
                ...
                .then((response) => {
                    if (response.data.success) {
                        alert("بلاگ اضافه شد!");
                        setAddMassage(true);
                        setTimeout(() => Navigate("/addblog"), 2000);
                    }
                })
                .catch((errors) => {
                ...
                <form className={styles.formContainer} onSubmit={submitHandler}>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            type="text"
                            name="title"
                            placeholder="مثلا: بلاگ شماره یک"
                            value={data.title}
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            rows="5"
                            cols="50"
                            placeholder="مثلا: توضیحات بلاگ شماره 1"
                    ...
                    <div className={styles.formdiv}>
                        {addMassage && <h6>بلاگ جدید با موفقیت ایجاد شد</h6>}
                    </div>
